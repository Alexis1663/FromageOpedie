...
<body>
    ...
    <section>
        ...
        <!-- Les fromages par département -->
        <div class="container">
            <div class="fromages">
                <div class="selection">
                    LA SÉLECTION DU DÉPARTEMENT : <span id="dep"></span>
                </div>
                <script type="text/javascript">
                    function affichDep(name) {
                        document.getElementById("dep").innerHTML = name;
                    }
                </script>
                <div class="image">
                    <?php if (isset($image)) { ?>
                        <img src="vue/ImageDep/<?= $image ?>" alt="Image du département : <?= $image ?>">
                    <?php } ?>
                </div>
                <div class="selection">
                    LES FROMAGES DE CE DEPARTEMENT :
                </div>
                <div class="selection_fromage">
                    <?php if (isset($fromage)) { ?>
                        <?php foreach ($fromage as $row) { ?>
                            <form action="">
                                <input type="submit" value="<?= utf8_encode($row['nom']) ?>">
                            </form>
                        <?php } ?>
                    <?php } ?>
                </div>
            ...
            <div class="carte">
                ...
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 667 578" xml:space="preserve">
                    <g class="region region-01" data-nom="Guadeloupe" data-code_insee="01">
                        <a href="index.php?page=carte&depart=guadeloupe">
                    ...
                    <g class="region region-02" data-nom="Martinique" data-code_insee="02">
                        <a href="index.php?page=carte&depart=martinique">
                    ...
                    <g class="region region-03" data-nom="Guyane" data-code_insee="03">
                        <a href="index.php?page=carte&depart=guyane">
                    ...
                    <g class="region region-04" data-nom="La Réunion" data-code_insee="04">
                        <a href="index.php?page=carte&depart=reunion">
                    ...
                    <g class="region region-06" data-nom="Mayotte" data-code_insee="06">
                        <a href="index.php?page=carte&depart=mayotte">
                    ...
                    <g class="region region-11" data-nom="Île-de-France" data-code_insee="11">
                        <a href="index.php?page=carte&depart=paris">
                        ...
                        <a href="index.php?page=carte&depart=seine-et-marne">
                        ...
                        <a href="index.php?page=carte&depart=yvelines">
                        ...
                        <a href="index.php?page=carte&depart=essonne">
                        ...
                        <a href="index.php?page=carte&depart=haut-de-seine">
                        ...
                        <a href="index.php?page=carte&depart=seine-saint-denis">
                        ...
                        <a href="index.php?page=carte&depart=val-de-marne">
                        ...
                        <a href="index.php?page=carte&depart=val-d-oise">
                    ...
                    <g class="region region-24" data-nom="Centre-Val de Loire" data-code_insee="24">
                        <a href="index.php?page=carte&depart=cher">
                        ...
                        <a href="index.php?page=carte&depart=eure-et-loir">
                        ...
                        <a href="index.php?page=carte&depart=indre">
                        ...
                        <a href="index.php?page=carte&depart=indre-et-loire">
                        ...
                        <a href="index.php?page=carte&depart=loir-et-cher">
                        ...
                        <a href="index.php?page=carte&depart=loiret">
                    ...
                    <g class="region region-27" data-nom="Bourgogne-Franche-Comté" data-code_insee="27">
                        <a href="index.php?page=carte&depart=cote-d-or">
                        ...
                        <a href="index.php?page=carte&depart=doubs">
                        ...
                        <a href="index.php?page=carte&depart=jura">
                        ...
                        <a href="index.php?page=carte&depart=nievre">
                        ...
                        <a href="index.php?page=carte&depart=haute-saone">
                        ...
                        <a href="index.php?page=carte&depart=saone-et-loire">
                        ...
                        <a href="index.php?page=carte&depart=yonne">
                        ...
                        <a href="index.php?page=carte&depart=territoire-de-belfort">
                    ...
                    <g class="region region-28" data-nom="Normandie" data-code_insee="28">
                        <a href="index.php?page=carte&depart=calvados">
                        ...
                        <a href="index.php?page=carte&depart=eure">
                        ...
                        <a href="index.php?page=carte&depart=manche">
                        ...
                        <a href="index.php?page=carte&depart=orne">
                        ...
                        <a href="index.php?page=carte&depart=seine-maritime">
                    ...
                    <g class="region region-32" data-nom="Hauts-de-France" data-code_insee="32">
                        <a href="index.php?page=carte&depart=aisne">
                        ...
                        <a href="index.php?page=carte&depart=nord">
                        ...
                        <a href="index.php?page=carte&depart=oise">
                        ...
                        <a href="index.php?page=carte&depart=pas-de-calais">
                        ...
                        <a href="index.php?page=carte&depart=somme">
                    ...
                    <g class="region region-44" data-nom="Grand Est" data-code_insee="44">
                        <a href="index.php?page=carte&depart=ardennes">
                        ...
                        <a href="index.php?page=carte&depart=aube">
                        ...
                        <a href="index.php?page=carte&depart=marne">
                        ...
                        <a href="index.php?page=carte&depart=haute-marne">
                        ...
                        <a href="index.php?page=carte&depart=meurthe-et-moselle">
                        ...
                        <a href="index.php?page=carte&depart=meuse">
                        ...
                        <a href="index.php?page=carte&depart=moselle">
                        ...
                        <a href="index.php?page=carte&depart=bas-rhin">
                        ...
                        <a href="index.php?page=carte&depart=haut-rhin">
                        ...
                        <a href="index.php?page=carte&depart=vosges">
                    ...
                    <g class="region region-52" data-nom="Pays de la Loire" data-code_insee="52">
                        <a href="index.php?page=carte&depart=loire-atlantique">
                        ...
                        <a href="index.php?page=carte&depart=maine-et-loire">
                        ...
                        <a href="index.php?page=carte&depart=mayenne">
                        ...
                        <a href="index.php?page=carte&depart=sarthe">
                        ...
                        <a href="index.php?page=carte&depart=vendee">
                    ...
                    <g class="region region-53" data-nom="Bretagne" data-code_insee="53">
                        <a href="index.php?page=carte&depart=cote-d-armor">
                        ...
                        <a href="index.php?page=carte&depart=finistere">
                        ...
                        <a href="index.php?page=carte&depart=ille-et-vilaine">
                        ...
                        <a href="index.php?page=carte&depart=morbihan">
                    ...
                    <g class="region region-75" data-nom="Nouvelle-Aquitaine" data-code_insee="75">
                        <a href="index.php?page=carte&depart=charente">
                        ...
                        <a href="index.php?page=carte&depart=charente-maritime">
                        ...
                        <a href="index.php?page=carte&depart=correze">
                        ...
                        <a href="index.php?page=carte&depart=creuse">
                        ...
                        <a href="index.php?page=carte&depart=dordogne">
                        ...
                        <a href="index.php?page=carte&depart=gironde">
                        ...
                        <a href="index.php?page=carte&depart=landes">
                        ...
                        <a href="index.php?page=carte&depart=lot-et-garonne">
                        ...
                        <a href="index.php?page=carte&depart=pyrenees-atlantiques">
                        ...
                        <a href="index.php?page=carte&depart=deux-sevres">
                        ...
                        <a href="index.php?page=carte&depart=vienne">
                        ...
                        <a href="index.php?page=carte&depart=haute-vienne">
                    ...
                    <g class="region region-76" data-nom="Occitanie" data-code_insee="76">
                        <a href="index.php?page=carte&depart=ariege">
                        ...
                        <a href="index.php?page=carte&depart=aude">
                        ...
                        <a href="index.php?page=carte&depart=aveyron">
                        ...
                        <a href="index.php?page=carte&depart=gard">
                        ...
                        <a href="index.php?page=carte&depart=haute-garonne">
                        ...
                        <a href="index.php?page=carte&depart=gers">
                        ...
                        <a href="index.php?page=carte&depart=herault">
                        ...
                        <a href="index.php?page=carte&depart=lot">
                        ...
                        <a href="index.php?page=carte&depart=lozere">
                        ...
                        <a href="index.php?page=carte&depart=hautes-pyrenees">
                        ...
                        <a href="index.php?page=carte&depart=pyrenees-orientales">
                        ...
                        <a href="index.php?page=carte&depart=tarn">
                        ...
                        <a href="index.php?page=carte&depart=tarn-et-garonne">
                    ...
                    <g class="region region-84" data-nom="Auvergne-Rhône-Alpes" data-code_insee="84">
                        <a href="index.php?page=carte&depart=ain">
                        ...
                        <a href="index.php?page=carte&depart=allier">
                        ...
                        <a href="index.php?page=carte&depart=ardeche">
                        ...
                        <a href="index.php?page=carte&depart=cantal">
                        ...
                        <a href="index.php?page=carte&depart=drome">
                        ...
                        <a href="index.php?page=carte&depart=isere">
                        ...
                        <a href="index.php?page=carte&depart=loire">
                        ...
                        <a href="index.php?page=carte&depart=haute-loire">
                        ...
                        <a href="index.php?page=carte&depart=puy-de-dome">
                        ...
                        <a href="index.php?page=carte&depart=rhone">
                        ...
                        <a href="index.php?page=carte&depart=savoie">
                        ...
                        <a href="index.php?page=carte&depart=haute-savoie">
                    ...
                    <g class="region region-93" data-nom="Provence-Alpes-Côte d&#39;Azur" data-code_insee="93">
                        <a href="index.php?page=carte&depart=alpes-de-haute-provence">
                        ...
                        <a href="index.php?page=carte&depart=hautes-alpes">
                        ...
                        <a href="index.php?page=carte&depart=alpes-maritimes">
                        ...
                        <a href="index.php?page=carte&depart=bouches-du-rhone">
                        ...
                        <a href="index.php?page=carte&depart=var">
                        ...
                        <a href="index.php?page=carte&depart=vaucluse">
                    ...
                    <g class="region region-94" data-nom="Corse" data-code_insee="94">
                        <a href="index.php?page=carte&depart=corse-du-sud">
                        ...
                        <a href="index.php?page=carte&depart=haute-corse">
            ...
            <div class="liste">
                <li><a href="#">Itinéraires</a>
                    <ul>
                        <li><a href="#">Route du Camembert</a></li>
                        <li><a href="#">Meilleurs fromages secs</a></li>
                    </ul>
                </li>
            </div>
